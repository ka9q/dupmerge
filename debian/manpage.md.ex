% dupmerge(SECTION) | User Commands
%
% "May 12 2026"
...
dupmerge - program to do something

# SYNOPSIS

**dupmerge** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**dupmerge** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **dupmerge** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**dupmerge** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    dupmerge. See **foo.conf**(5) for further details.
...
**dupmerge** provides some return codes, that can be used in scripts:
